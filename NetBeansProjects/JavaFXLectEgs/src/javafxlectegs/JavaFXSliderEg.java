...
public class JavaFXSliderEg extends Application {
    ...
    public void start(Stage stage) {
        ...
        photo.setEffect(sepiaEffect);
        GridPane.setConstraints(photo, 0, 0);
        GridPane.setColumnSpan(photo, 3);
        grid.getChildren().add(photo);
        scene.setRoot(grid);
        ...
        opacityLevel.valueProperty().addListener((ObservableValue<? extends Number> ov, Number old_val, Number new_val) -> {
            photo.setOpacity(new_val.doubleValue());
        ...
        scaling.valueProperty().addListener(new ChangeListener<Number>() {
            public void changed(ObservableValue<? extends Number> ov,
                Number old_val, Number new_val) {
                    photo.setScaleX(new_val.doubleValue());
                    photo.setScaleY(new_val.doubleValue());
